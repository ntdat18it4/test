...
import com.thaonx.mockt3h.view.fragment.news.SearchFragmentDirections

class ItemSearchAdapter : RecyclerView.Adapter<ItemSearchAdapter.ItemHomeViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ItemSearchAdapter.ItemHomeViewHolder {
        binding = ItemHomeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ItemHomeViewHolder(binding!!)
    }

    override fun onBindViewHolder(holder: ItemSearchAdapter.ItemHomeViewHolder, position: Int) {
        ...
        fun bind(articles: Articles) {
           ...
           binding.article = articles
            ...
            itemView.setOnClickListener { mView ->
                val action = SearchFragmentDirections.actionSearchFragmentToDetailFragment(articles)
